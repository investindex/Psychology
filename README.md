...
My risky, long-term portfolio is the complex portfolio [here](https://github.com/investindex/Fund/blob/main/README.md#example-portfolio). For low-risk investing, I'll use a combination of [Series I savings bonds](https://github.com/investindex/Risk#us-treasury-savings-bonds), the short-term treasury bond fund [SCHO](https://www.schwabassetmanagement.com/products/scho), and the moderately risky bond fund [DFCF](https://us.dimensional.com/etfs/dfcf/core-fixed-income-etf)." [↩](#fn1)
...
Performance chasing and essentializing. US stocks have high returns and international stocks have low returns. Apple is a "good stock" that performs well.
-->
