...
>
> My risky, long-term portfolio is the complex portfolio [here](https://github.com/investindex/Fund/blob/main/README.md#example-portfolios). For low-risk investing, I'll use a combination of [Series I savings bonds](https://github.com/investindex/Risk#us-treasury-savings-bonds), the short-term US Treasury bond fund [SCHO](https://www.schwabassetmanagement.com/products/scho), and the moderately risky bond fund [DFCF](https://us.dimensional.com/etfs/dfcf/core-fixed-income-etf). If there is money I want to preserve without risk because I may need short-term liquidity, I'll use [SGOV](https://www.ishares.com/us/products/314116/ishares-0-3-month-treasury-bond-etf-fund) or a money market fund. [↩](#fn1)
